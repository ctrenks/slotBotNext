...
const MobileMenu = ({ items }: { items: { name: string; href: string }[] }) => {
  ...
  return (
    <>
      ...
      ></label>
      <div className="fixed right-0 top-0 h-full w-full sm:w-96 bg-black shadow-lg transform translate-x-full peer-checked:translate-x-0 transition-transform duration-200 ease-in-out md:hidden z-50">
        <nav className="p-6">
